...
final class V015AgentTests:XCTestCase {
    ...
    func testLaunchAgentIsBoundedSystemJobNotPermanentGuiProcess()throws {
        ...
        let plist=source.appendingPathComponent("Resources/LaunchAgents/org.mailportrait.sync.plist")
        let v=try XCTUnwrap(PropertyListSerialization.propertyList(from:Data(contentsOf:plist),format:nil) as? [String:Any])
        XCTAssertEqual(v["BundleProgram"] as? String,"Contents/MacOS/MailPortrait")
