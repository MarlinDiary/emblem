...
final class V016GmailTests:XCTestCase {
    ...
    @MainActor func testOpeningImageLibraryPublishesDecodedRowsOnlyOnce()throws {
        ...
        let rows=(0..<120).map { i in SenderRow(email:EmailAddress("mailportrait-fixture-\(String(i))@gmail.com")!,name:"Sender \(String(i))",candidates:[avatar],selectedCandidate:avatar.id,selectionIsManual:true,discoveryOrder:i) }
