...
final class V014BaselineTests:XCTestCase {
 ...
 func testStreamlinedMainFlow() throws {
  let base=URL(fileURLWithPath:#filePath).deletingLastPathComponent().deletingLastPathComponent().deletingLastPathComponent().appendingPathComponent("Sources/MailPortrait")
  let main=try String(contentsOf:base.appendingPathComponent("MailPortraitApp.swift")),detail=try String(contentsOf:base.appendingPathComponent("SenderViews.swift"))
