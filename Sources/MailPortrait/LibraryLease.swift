...
final class LibraryLease {
    ...
    static var liveRoot:URL {FileManager.default.urls(for:.applicationSupportDirectory,in:.userDomainMask)[0].appendingPathComponent("MailPortrait",isDirectory:true)}
