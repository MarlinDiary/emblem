...
@MainActor enum SelfTest {
    ...
    static func rollback(arguments: [String]) -> Int32 {
        do {
            ...
            guard try String(contentsOf: root.appendingPathComponent("fixture.marker"), encoding: .utf8) == "MailPortrait isolated fixture v1\n" else { throw PortraitError.message("not a MailPortrait fixture") }
